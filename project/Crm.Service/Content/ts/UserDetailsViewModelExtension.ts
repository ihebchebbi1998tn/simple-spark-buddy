...
export class UserDetailsViewModelExtension extends window.Main.ViewModels.UserDetailsViewModel {
	private selectedStoreId: KnockoutObservable<string>;
	private selectedStorageAreaId: KnockoutObservable<string>;
	private selectedLocationId: KnockoutObservable<string>;
	...
	onLocationSelect = async function (userExtensionValues: Default.ObservableMain_User_ExtensionValues, location: Crm.Article.Rest.Model.CrmArticle_Location) {
		this.loading(true);
		if (location != null && location.StorageArea != null) {
