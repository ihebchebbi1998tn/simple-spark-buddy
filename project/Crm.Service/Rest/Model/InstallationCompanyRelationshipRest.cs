namespace Crm.Service.Rest.Model
{
	...
	[RestTypeFor(DomainType = typeof(InstallationCompanyRelationship))]
	public class InstallationCompanyRelationshipRest : RestEntityWithExtensionValues
	{
		...
		public CompanyRest Child { get; set; }
