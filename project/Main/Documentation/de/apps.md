...
Beim Einsatz eines mobilen Endgerätes empfiehlt es sich hierfür die native L-mobile App zu verwenden. Diese steht derzeit für Android und Apple iOS zur Verfügung und bietet eine verbesserte Performance, sowie diverse Zusatzfunktionalitäten, die in Browsern nicht zur Verfügung stehen. 
...
Diese Seite beinhaltet eine Schaltfläche um die App zu installieren, welches über den Google Play Store (Android), über iTunes (Apple iOS) realisiert ist. Hierüber können auch Updates der App bezogen werden.
