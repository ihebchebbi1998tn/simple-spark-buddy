namespace Main.Database
{
	...
	[Migration(20180927103000)]
	public class AddMaintenanceSolution : Migration
	{
		public override void Up()
		{
			#region ExecuteCommand

			Database.ExecuteNonQuery(@"SET ANSI_NULLS ON");
			Database.ExecuteNonQuery(@"SET QUOTED_IDENTIFIER ON");
...
END");
			Database.ExecuteNonQuery(@"ALTER PROCEDURE [dbo].[CommandExecute]
...
END");
			Database.ExecuteNonQuery(@"ALTER PROCEDURE [dbo].[IndexOptimize]
