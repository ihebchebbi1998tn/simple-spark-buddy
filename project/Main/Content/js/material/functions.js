...
$(document).ready(function(){
    ...
    (function () {
		...
		$('body').on('click', '#sidebar .pin', function () {
    ...
    (function(){
        $('body').on('click', '#top-search > a', function(e){
			...
			const theme = $("#header").attr("data-current-skin");
			$("#top-search-wrap > div").attr("data-current-skin", theme);
  ...
  (function () {
      $('body').on('click', '#logout', function (e) {
          e.preventDefault();
          window.Helper.Database.saveToLocalStorage("logout-event", "logout" + Math.random());
          window.Helper.User.getCurrentUser().then(function (user) {
              localStorage.setItem("last-user-login", window.Helper.String.hash(user.Email));
              window.location = window.Helper.Url.resolveUrl("~/Main/Account/Logout");
          });
      });
        //Toggle
	    ...
	    $('.profile-menu:not(.toggled) .main-menu').hide();
    ...
    */
     ...
     * Audio and Video
     */
    /* Note! This is commented out, because it is failing when a Video element is in the DOM */
    // if($('audio, video')[0]) {
