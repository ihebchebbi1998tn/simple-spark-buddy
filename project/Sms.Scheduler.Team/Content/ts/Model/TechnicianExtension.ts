...
export class TechnicianExtension extends window.Sms.Scheduler.Model.Technician {
	static get $name() {
		return 'TechnicianExtension';
	}
...
window.Sms.Scheduler.Model.Technician = TechnicianExtension;